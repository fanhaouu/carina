...
func (r *NodeDeviceReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	_ = context.Background()
	_ = r.Log.WithValues("nodedevice", req.NamespacedName)
...
func (r *NodeDeviceReconciler) SetupWithManager(mgr ctrl.Manager) error {
